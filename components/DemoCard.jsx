    ...
    if (variant===0){
        ...
        >
          <div className='grid grid-cols-4 grid-rows-5 grid-flow-dense w-full h-full gap-0'>
            ...
            <div style={{backgroundColor:colorList[4].hex, clipPath: 'polygon(0% 0%, 50% 0%, 100% 100%, 0% 100%)',}} className='group col-start-3 col-span-2 row-start-1 row-span-1' 
              onMouseOver={(e)=>handleEnter(e,colorList[4],"abstract")} onMouseOut={e=>handleExit(e)}>
            </div>
          </div>
        </div>
      )
      ...
      setContent(
        <div style={{backgroundColor:"#FFFFFF"}} className=' w-full h-full'>
          <div className='grid grid-cols-4 grid-rows-5 grid-flow-dense w-full h-full gap-0'>
            <div style={{backgroundColor:utilitiesColorList[4].hueGroup[0].hex}} className='col-start-1 z-[1] rounded-full col-span-3 row-start-1 row-span-1' 
              onMouseOver={(e)=>handleEnter(e,utilitiesColorList[4].hueGroup[0],"abstract")} onMouseOut={e=>handleExit(e)}>
            </div>
          </div>
        </div>
      )
